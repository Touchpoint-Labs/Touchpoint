...
The `Backend` ABC handles **element-aware** operations: discovering the UI tree, reading element properties, and performing native accessibility actions. It has **10 abstract methods** and **7 concrete methods** with safe defaults:
